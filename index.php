...
<body>
	 ...
	 <span class="maequee"><marquee><b>This is library mangement system. Library opens at 8:00 AM and close at 8:00 PM</b></marquee></span><br>
            ...
            <div class="bg"
            style=" background:rgba(0,0,0,0.7) url(bg.jpg);background-blend-mode:darken;background-size:contain; "> 
	       <div class="row">
	...
	<div class="facilities">
		...
		<div class= "  col-md-6" id="main_content">
			<div class="facilities">
		   <center><h3 class="facilities" >User Login Form </h3></center>
			<form action="" method="post"><br>
				
				<div class="form-group">
					<label for="email">Email ID:</label>
					<input  type="text" name="email" placeholder="Type your e-mail id......." class="form-control" required>
				</div><br>
				<div class="form-group">
